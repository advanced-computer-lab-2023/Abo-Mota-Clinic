...
import { useUploadHealthRecordMutation } from "../../../store";

const AddHealthRecordScreen = ({ closeForm, patient }) => {
  const [isLoading, setIsLoading] = useState(false);
  const [uploadHealthRecord, results] = useUploadHealthRecordMutation();
  const handleSubmit = async (values, { resetForm }) => {
    ...
    await uploadHealthRecord({
      ...
      healthRecord: values.healthRecord,
      id: patient._id,
    });
    ...
    <div className="add-health-record-portal-container">
      <div className="add-health-record-portal">
        <div className="add-health-record-button-container">
          ...
          <span className="add-health-record-close-button-span" onClick={closeForm}>
